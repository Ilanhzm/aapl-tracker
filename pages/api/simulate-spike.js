...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 4. Find ATM / OTM+1 / OTM+2 (strikes BELOW simulated spike price)
    ...
    // 5. Build exact Telegram message
